  ...
  return (
    <>
      ...
      <div className="flex justify-center mt-20">
        <button className="flex items-center bg-accent text-white hover:bg-white font-regular py-2 px-6 transition duration-300 ease-in-out group hover:text-accent hover:border-2 hover:border-accent">
