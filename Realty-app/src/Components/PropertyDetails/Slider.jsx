...
function SliderImg() {
    ...
    return (
    <div className='max-w-[1420px] h-[480px] lg:h-[680px] mx-2 md:mx-14 m-auto mt-4 py-24 px-2 relative group transition-all ease-in-out duration-300'>
    ...
    {/* Right Arrow */}
        ...
        <div className='flex top-10 items-center justify-center py-4 gap-1 md:gap-2'>
            {slides.map((_, i) => (
                <div className={`transition-all w-1.5 h-1.5 md:w-2 md:h-2 bg-accent rounded-full
                ${currentIndex === i ? "transition-all ease-in-out duration-300 p-0.5 md:p-1" : "bg-opacity-40"}
                `}
                />
